/**
 * Must stay aligned with the shared auth/community schema. Only the tables
 * needed by the read-state service are included here.
 */
import { pgTable, uuid, text, jsonb, timestamp, integer, primaryKey, boolean } from "drizzle-orm/pg-core";
